...
cost ..    result  =e=  sum((d,s), costMatrix(d,s) * (arctan(1000*(x(d,s)-2))/Pi + 0.5 + arctan(1000*(x(d,s)-4))/Pi + 0.5 + arctan(1000*(x(d,s)-6))/Pi + 0.5 + arctan(1000*(x(d,s)-8))/Pi + 0.5 + arctan(1000*(x(d,s)-10))/Pi + 0.5)) ;
Model transport /all/ ;
Solve transport using DNLP minimizing result ;